...
public class RSSFeed implements Iterable<RSSMessage> {
    ...
    public String toString() {
        ...
        sb.append("<opensearch:itemsPerPage>").append(this.size()).append("</opensearch:itemsPerPage>\n");
        sb.append("<opensearch:totalResults>").append(this.size()).append("</opensearch:totalResults>\n");
